                ...
                <div className='w-full h-auto px-[30px] mb-[40px]'>
                    {userData && (
                        <>
                            ...
                            {/* Datos de Perfil*/}
                            <div className='rounded-md shadow-lg border-[2px] border-primary flex flex-col mt-[10px] rounder-lg bg-primary/10 px-[20px] py-[30px] w-full h-auto'>
                                                    ...
                                                    <div className='w-full sm:flex sm:flex-col-1 lg:flex lg:flex-row gap-2 lg:gap-7 justify-between' >
                                                        ...
                                                        <div className='flex flex-row gap-2'>
                                                            ...
                                                            <div className='flex flex-row gap-2 mt-3'>
                                                                ...
                                                                <button onClick={() => { router.push(`/submit-answer?taskId=${x.id}`) }} className='bg-secondary hover:bg-secondary/50 text-black w-[40px] h-[40px] rounded-[50%]'>
